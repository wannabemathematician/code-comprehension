...
├── apps/
│   ├── web/            # React frontend
│   └── api/            # Serverless Node.js API (AWS Lambda)
│
...
│
├── challenges/         # Local challenge authoring (not deployed)
│
├── scripts/            # Helper scripts (zip + upload challenges, etc.)
│
└── README.md
...
Local authoring format (example)
challenges/
  auth-bugfix-1/
    meta.json
    slack.md
